...
if __name__ == "__main__":
    ...
    STATE_FILE = BASE / "data" / "neutron" / f"monthly_ic_pilot_orbiter_{INSTRUMENT.lower()}_state.json"
    LEDGER_FILE = BASE / "logs" / "neutron" / f"monthly_ic_pilot_orbiter_{INSTRUMENT.lower()}.jsonl"
