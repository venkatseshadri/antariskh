...
Standalone script (no def test_* — module-level code guarded by __main__ so
pytest can collect this file without triggering a real DeepSeek/CrewAI call).
Run: python3 tests/test_chain_librarian_executioner.py
"""
