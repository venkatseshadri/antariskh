...
# Fix GetPositionsTool args_schema (imported from ta_strategy_tools)
from tools.ta_strategy_tools import MarketDataInput as _MDI

GetPositionsTool.args_schema = _MDI
