...
SYSTEMS = {
    ...
    "proton": [
        str(ANTARIKSH / "logs" / "proton_live_cron*.log"),
        str(ANTARIKSH / "logs" / "proton_plus_live_cron*.log"),
        str(ANTARIKSH / "logs" / "proton_live.jsonl"),
        str(ANTARIKSH / "logs" / "proton_live_dry.jsonl"),
        str(ANTARIKSH / "logs" / "proton_live_dry_plus.jsonl"),
        str(ANTARIKSH / "data" / "proton_live_dry_state_plus.json"),
    ],
    "neutron": [
        str(ANTARIKSH / "logs" / "monthly_ic_pilot_cron*.log"),
        str(ANTARIKSH / "logs" / "monthly_ic_pilot_orbiter_nifty_cron*.log"),
        str(ANTARIKSH / "logs" / "monthly_ic_pilot_orbiter_sensex_cron*.log"),
        str(ANTARIKSH / "logs" / "monthly_ic_pilot.jsonl"),
        str(ANTARIKSH / "logs" / "monthly_ic_pilot_orbiter_nifty.jsonl"),
        str(ANTARIKSH / "logs" / "monthly_ic_pilot_orbiter_sensex.jsonl"),
        str(ANTARIKSH / "data" / "monthly_ic_pilot_state.json"),
        str(ANTARIKSH / "data" / "monthly_ic_pilot_orbiter_nifty_state.json"),
        str(ANTARIKSH / "data" / "monthly_ic_pilot_orbiter_sensex_state.json"),
    ],
    "hydrogen": [
        str(ANTARIKSH / "logs" / "hydrogen_ic_pilot_orbiter_nifty_cron*.log"),
        str(ANTARIKSH / "logs" / "hydrogen_ic_pilot_orbiter_sensex_cron*.log"),
        str(ANTARIKSH / "logs" / "hydrogen_ic_pilot_orbiter_nifty.jsonl"),
        str(ANTARIKSH / "logs" / "hydrogen_ic_pilot_orbiter_sensex.jsonl"),
        str(ANTARIKSH / "data" / "hydrogen_ic_pilot_orbiter_nifty_state.json"),
        str(ANTARIKSH / "data" / "hydrogen_ic_pilot_orbiter_sensex_state.json"),
    ],
    "penguin": [
